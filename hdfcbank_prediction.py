"""
Single Stock Inference: HDFC Bank (HDFCBANK.NS)
...
if isinstance(df.columns, pd.MultiIndex):
    # For single-symbol download, columns are like ('Close', 'HDFCBANK.NS')
...
# ============================================================================
# COMPUTE FEATURES FOR HDFC BANK
# ============================================================================
...
result_df.to_csv('output/hdfcbank_prediction.csv', index=False)
print(f"\n✓ Prediction saved to: output/hdfcbank_prediction.csv")
